	...
	public function enable_step($old_state)
	{
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				$phpbb_notifications->enable_notifications('zukero.userbbcode.notification.type.username');
	...
	public function disable_step($old_state)
	{
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				$phpbb_notifications = $this->container->get('notification_manager');
				$phpbb_notifications->disable_notifications('zukero.userbbcode.notification.type.username');
				return 'notifications';
	...
	public function purge_step($old_state)
	{
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				$phpbb_notifications = $this->container->get('notification_manager');
				$phpbb_notifications->purge_notifications('zukero.userbbcode.notification.type.username');
				return 'notifications';

...
/**
* Post username notifications class
* This class handles notifying users when they have been mentioned with a user tag in a post
*/

class username extends \phpbb\notification\type\quote
{
	...
	*/
	...
	{
		return 'zukero.userbbcode.notification.type.username';
	}
	...
	* @var string
	*/
	protected $language_key = 'NOTIFICATION_USERNAME';
	...
	*/
	static public $notification_option = array(
		'lang'	=> 'NOTIFICATION_TYPE_USERNAME',
	...
	*/
	...
	{
		return '@zukero_usernamebbcode/username';
	}
	...
	*/
	public function get_mentioned_users($xml)
	{
		...
		foreach ($xpath->query('//USER[not(ancestor::QUOTE)]/text()') as $user)
		{
			$users[] = $user->textContent;
		}

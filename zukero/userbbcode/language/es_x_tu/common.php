...
$lang = array_merge($lang, array(
	...
	'NOTIFICATION_TYPE_USERNAME'		=> 'Alguien te menciona en un mensaje con la etiqueta [user]',
	'BBCODE_USERNAME_HELP'				=> 'Menciona a un usuario con la etiqueta [user]username[/user]',
